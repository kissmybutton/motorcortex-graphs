...
export default function buildCSS(cssArgs) {
  ...
  const styles = {
    "container-progressBar": {
      height: "100%",
      background: cssArgs.palette.background
        ? cssArgs.palette.background
        : DefaultStyle.colorPalette.background,
      display: "flex",
      color: cssArgs.palette.font
        ? cssArgs.palette.font
        : DefaultStyle.colorPalette.font,
      "font-family": cssArgs.font.fontFamily
    ...
    "container-bar": {
      ...
      background: cssArgs.palette.secondary
        ...
        : DefaultStyle.colorPalette.darkGray,
      "border-radius": "4rem",
      width: "60%",
      "box-shadow": "2px 2px 5px gray",
      border: `0.2rem solid ${
        cssArgs.palette.accent
          ? cssArgs.palette.accent
          : DefaultStyle.colorPalette.accent
      }`,
      "z-index": "1",
      overflow: "hidden",
    },
    "inner-bar": {
      ...
      background: cssArgs.palette.primary
        ...
        : DefaultStyle.colorPalette.lightGray,
      height: "102%",
      "border-radius": "4rem",
      bottom: "-1px",
      "z-index": "2px",
